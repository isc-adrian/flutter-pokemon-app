...
class PokemonWeaknessesTable extends TableDataBase{

  static const String TABLE_NAME = "pokemonWeaknesses";
  ...
  PokemonWeaknessesTable({@required this.myDataBase, @required dbVersion}): super(dbVersion: dbVersion);
